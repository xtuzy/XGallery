...
{
#if __ANDROID__
    public class LayerView_M : SKCanvasView
    {
#elif __IOS__
    public class LayerView_M : SKCanvasView
    {
#elif __UWP__
    public class LayerView_M : SKXamlCanvas
    {
#elif __WPF__
    public class LayerView_M : SkiaSharp.Views.WPF.SKElement
    {
#endif
        ...
        SKSize ViewSize;
#if __ANDROID__
        public LayerView_M(Context context) : this(context, null)
        {
        }

        public LayerView_M(Context context, IAttributeSet attrs) :
            base(context, attrs)
        {
        }

        public LayerView_M(Context context, IAttributeSet attrs, int defStyle) :
        ...
        private void RenderLoopMethod()
        {
            ...
            if (MainThread.IsMainThread)
                ...
                if (MainThread.IsMainThread)
                    ...
                    MainThread.BeginInvokeOnMainThread(() => this.SetNeedsDisplay());
#elif __UWP__
            this.Invalidate();   
#elif __WPF__
                if (MainThread.IsMainThread)
                    ...
                    MainThread.BeginInvokeOnMainThread(() => this.InvalidateVisual());
#endif
